...
public class BookConsoleApp {
    public static void main(String[] args) {
        ...
        BookFlightService bookFlightService = new BookFlightServiceImpl(bookFlightDaoInter, bookFlightMapper);
        BookFlightController bookFlightController = new BookFlightController(bookFlightService);
       //   flightController.create(new FlightDto("Asankara", "2024-11-22 11:00:00", 100, 60));
